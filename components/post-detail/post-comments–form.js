    ...
    <div className="max-w-2xl mx-auto px-4">
      ...
      <form className="mb-6" onSubmit={submitHandler}>
        <div
          ...
          <textarea id="comment" rows="5" ref={textRef}
        ...
        <div className="grid gap-6 mb-6 md:grid-cols-2">
          <div>
            <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-stone-900 dark:text-white">Nickname
              (optional)</label>
            <input type="text" id="first_name" ref={nameRef}
          ...
          <div>
            <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-stone-900 dark:text-white">Email
              (optional)</label>
            <input type="text" id="last_name" ref={emailRef}
                   className=" border border-stone-300 text-stone-900 text-sm rounded-lg block w-full p-2.5 dark:bg-stone-800 dark:border-stone-600 dark:placeholder-stone-400 dark:text-white"
                   placeholder="email"/>
          </div>
        </div>
